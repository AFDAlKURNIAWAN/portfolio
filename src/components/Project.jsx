...
const Project = () => {
  ...
  const selectedSertif = sertifData.find(
    (sertif) => sertif.id === activeSertifId,
  );
    ...
    <section className="lg:px-40 md:px-20 pt-20" id="project">
      ...
      >
        ...
        >
          ...
          >
            <h1 className="text-base font-medium sm:text-base md:text-lg">
              Projects
            </h1>
          </div>
            ...
            >
              ...
              <div className="p-6 bg-white">
                <h2 className="text-xl font-bold text-gray-900">
                  {selectedSertif?.title}
                </h2>
                <p className="mt-2 text-sm text-gray-600">
                  {selectedSertif?.shortDesc}
                </p>
                <button
                  onClick={() => setActiveSertifId(null)}
