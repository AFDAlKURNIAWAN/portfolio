...
const images = [
  {
    ...
    alt: "icon html",
    duration: 6,
    className: "md:top-10 md:left-40 top-20 left-10",
  },
  {
    src: JavascriptIcon,
    alt: "icon js",
    duration: 7,
    className: "md:right-20 right-5 top-48",
  },
  {
    src: reactIcon,
    alt: "icon react",
    duration: 8,
    className: "md:left-10 left-5 bottom-28",
  },
  {
    src: codeIcon,
    alt: "icon code",
    duration: 9,
    className: "md:bottom-20 bottom-5 md:right-60 right-20",
  },
];
...
const Hero = () => {
  return (
    <section
      className="relative px-10 md:py-45 py-35 overflow-hidden"
      id="home"
    >
      <motion.div
        initial="hidden"
      ...
      >
        ...
        <motion.div
          variants={fadeIn}
          className="text-7xl text-center font-medium mb-4 md:text-8xl"
        >
          <h1>
        ...
        <motion.div
          variants={fadeIn}
          className="text-[19px] md:text-2xl font-light mb-6 text-gray-900"
        >
          <p>
            I am a student who has a hobby in front end developer and I like
        ...
        >
          <a
            href="#project"
            className="bg-black shadow-2xl rounded-full px-6 py-2 md:text-[19px] text-gray-200 hover:bg-gray-900 transition duration-300 ease-in-out"
          >
            Project
          </a>
          <a
            href="afdal.pdf"
            className="border border-black px-6 py-2 md:text-[19px] rounded-full shadow-2xl hover:bg-black hover:text-white transition duration-300 ease-in-out"
            download="afdal.pdf"
          >
            Resume
          </a>
